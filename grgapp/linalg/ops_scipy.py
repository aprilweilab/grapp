...
class SciPyXTXOperator(LinearOperator):
    ...
    def _matmat(self, other_matrix):
        ...
        sub_const = (
            self.mult_const * self.freqs * numpy.transpose(other_matrix) / self.sigma
        )
        ...
        sub_const2 = (self.mult_const * self.freqs / self.sigma) * col_const
